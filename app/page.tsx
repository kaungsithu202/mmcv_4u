          ...
          <div className="col-span-5 grid gap-3">
            ...
            <div>
              <Accordion type="single" collapsible>
                ...
                >
                  <AccordionTrigger>Create Education</AccordionTrigger>
                  <AccordionContent>
                    <EducatioForm />
                  </AccordionContent>
                </AccordionItem>
            ...
            <div>
              <Accordion type="single" collapsible>
                <AccordionItem
                  ...
                  className="bg-white rounded-xl  px-6 py-4"
                >
                  <AccordionTrigger>Create Skill</AccordionTrigger>
                  <AccordionContent>
                    <Skill />
                  </AccordionContent>
                </AccordionItem>
            ...
            <div>
              <Accordion type="single" collapsible>
                <AccordionItem
                  ...
                  className="bg-white rounded-xl  px-6 py-4"
                >
                  <AccordionTrigger>Create Language</AccordionTrigger>
                  <AccordionContent>
                    <Language />
                  </AccordionContent>
                </AccordionItem>
            ...
            <div>
              <Accordion type="single" collapsible>
                <AccordionItem
                  ...
                  className="bg-white rounded-xl  px-6 py-4"
                >
                  <AccordionTrigger>Create Certificate</AccordionTrigger>
                  <AccordionContent>
                    <Certificate />
                  </AccordionContent>
                </AccordionItem>
            ...
            <div>
              <Accordion type="single" collapsible>
                <AccordionItem
                  ...
                  className="bg-white rounded-xl  px-6 py-4"
                >
                  <AccordionTrigger>Create Interest</AccordionTrigger>
                  <AccordionContent>
                    <Interest />
                  </AccordionContent>
                </AccordionItem>
            ...
            <div>
              <Accordion type="single" collapsible>
                <AccordionItem
                  ...
                  className="bg-white rounded-xl  px-6 py-4"
                >
                  <AccordionTrigger>Create Reference</AccordionTrigger>
                  <AccordionContent>
                    <Reference />
                  </AccordionContent>
                </AccordionItem>
